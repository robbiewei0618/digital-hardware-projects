`timescale 1ns/1ps
module tb_16x8;
    parameter M = 16, N = 8, NUM_TESTS = 100;
    localparam MN = M + N;
    ...
    initial begin
        $readmemh("16x8_a.txt", a_mem);
        $readmemh("16x8_b.txt", b_mem);
        $readmemh("16x8_ans.txt", ans_mem);
        #10;
        ...
        $display("16x8: op=%0d row=%0d row_opt=%0d mbw=%0d booth=%0d booth_opt=%0d", 
